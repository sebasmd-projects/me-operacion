/* =====================================================================
   logica-hlr-hss-ambos.js · Motor "Ambos" de la pestaña HLR/HSS
   ---------------------------------------------------------------------
   Copia envuelta de logica-hlr-cruzado.js (¿En que HLR esta?), SIN tocar
   una sola linea de sus reglas de negocio. Ver logica-hlr-hss-tigo.js
   para el porque del envoltorio y de exponer filasExport/
   filasParaExportar (el puente los necesita para los botones de
   exportacion, y vive fuera del IIFE).
===================================================================== */
(function () {
"use strict";
...
// Diferido hasta que la pestaña "Ambos" se monte de verdad (ver
// me-hlr-hss-puente.js) — misma razon que en logica-hlr-hss-tigo.js.
window.MotorAmbos = {
    iniciar: inicializarCruce,
